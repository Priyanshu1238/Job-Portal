...
const Subscribe = () => {
  const hanlePost = () => {
        ...
        successNotification("Success", "Subscribe Successfully");
  ...
  return (
    <div className="mt-20 flex items-center bg-mine-shaft-900 mx-20 py-3 rounded-xl justify-around">
      ...
      size="xl"
    />
    <Button className="rounded-lg " size="xg" color="brightSun.5"  onClick={hanlePost} variant="filled"><span className="text-mine-shaft-950 font-semibold">Subscribe</span></Button>
        </div>
    </div>
  )
}
