import {  faMapMarkerAlt, faBolt, faSearch } from "@fortawesome/free-solid-svg-icons";
export const searchFields=[
    ...
    },
    {
        title:"Skills",
        icon:faBolt,
        options:["HTML", "CSS", "JavaScript", "TypeScript", "React", "Vue", "Angular", 
    "Svelte", "Next.js", "Nuxt.js", "Node.js", "Express.js", "NestJS", 
    "GraphQL", "REST API", "Redux", "Zustand", "Tailwind CSS", "Bootstrap", 
    "Material UI", "Chakra UI", "SASS", "LESS", "Styled Components", 
    "Webpack", "Vite", "Babel", "ESLint", "Jest", "Mocha", "Cypress", 
    "Playwright", "Testing Library", "React Native", "Flutter", "Swift", 
    "Kotlin", "Java", "Python", "Django", "Flask", "FastAPI", "Spring Boot"]
    }
]
